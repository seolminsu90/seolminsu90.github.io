...
var careerTextData = [
    ...
    },
    {
        ...
        content: [
            ...
            "모바일/PC 크래시 리포트 관련 수집기 및 이슈 관리 툴 개발",
    ...
    },
    {
        ...
        content: [
            "넷마블 게임 운영 지원 툴 커뮤니티 관리, 이슈 공유 파트 개발",
            "넷마블 게임 운영 지원 툴 Selenium 기반 크롤링 모듈 개발 (각종 게임 커뮤니티 게시글 수집)"
        ]
    },
    {
        start: "2018-10",
        ...
        content: [
            "<b>아이지에스 </b>입사",
            "넷마블 게임 글로벌 커뮤니티 모비럼 리뉴얼 작업",
            "Gitlab, Runner 이용한 CI/CD 구축"
        ]
    },
    {
        start: "2018-04",
        ...
        content: [
            "좀비파우 퍼즐 게임 개발 (DB 설계, 웹 서버 API, 게임 운영툴, 인증, 빌링, 이벤트 등 플랫폼 기능 개발)",
            "퍼드럭 미국 병원 환자 대상 약 복용 체크 앱 관리 운영툴 페이지, API 서버 및 DB, 웹 담당"
        ]
    },
    {
        start: "2017-07",
    ...
    },
    {
        ...
        content: [
            "씽크매스 웹 이러닝 서비스 DB, REST API 개발",
            "코리아그랜드세일 해외 관광객 대상 면세점 쿠폰 발급 앱 서비스 데이터베이스, REST API, 운영툴 개발"
        ]
    },
    {
        start: "2015-07",
        ...
        content: [
            "챗그랩 SNS 웹/앱 서비스 개발 (DB 구축, REST API, 웹 개발 담당)",
            "현대 글로비스 사내 물류 CCTV 관제 시스템 웹 서비스 개발",
            "슈퍼스타 게임즈 모바일 게임 메인 페이지/이벤트 웹 페이지 개발"
        ]
    }, {
        start: "2014-09",
        end: "2015-06",
...
var portpolioData = [
    ...
    {
        src: [
            "img/igs/mobirum/1.png", "img/igs/mobirum/2.jpg"
        ],
        isHorizontal: true,
        title: "모비럼 게임 커뮤니티",
        start: "2018-10",
        ...
        work: [
            "메인 대문 사이트 웹 백엔드 및 프론트엔드 개발",
            "메인 대문 사이트 통합검색 ES 구축 및 Monstache 동기화, 검색 구현"],
        tag: ["Java", "Spring Boot", "Elasticsearch", "Mongodb", "Freemaker", "Thymeleaf"],
    },
    {
        src: [
            "img/omakorea/zombiepoww/1.jpg",
            "img/omakorea/zombiepoww/2.png",
            "img/omakorea/zombiepoww/3.png",
            "img/omakorea/zombiepoww/4.png",
        ],
        isHorizontal: true,
    ...
    {
        src: [
            "img/omakorea/pudluck/1.jpg",
            "img/omakorea/pudluck/2.jpg",
            "img/omakorea/pudluck/3.jpg",
            "img/omakorea/pudluck/4.jpg",
            "img/omakorea/pudluck/5.jpg",
            "img/omakorea/pudluck/6.jpg",
            "img/omakorea/pudluck/7.jpg",
        ],
        isHorizontal: true,
        title: "퍼드럭 투약 관리 서비스",
        start: "2018-04",
    ...
    {
        src: [
            "img/omakorea/powerfishing/1.jpg",
            "img/omakorea/powerfishing/2.png",
            "img/omakorea/powerfishing/3.png",
            "img/omakorea/powerfishing/4.png",
        ],
    ...
    {
        src: [
            "img/omakorea/hallpass/1.png",
            "img/omakorea/hallpass/2.png",
            "img/omakorea/hallpass/3.png",
        ],
    ...
    },
    {
        ...
        work: [
            ...
            "AWS (beanstalk, rds, s3, route)",
            "앱 Push 서버 (알림, 보상 등)",
            "인앱 결제(ios/android/tencent)",
            "게임대회 시스템, 이벤트 배치 및 스케쥴링"
        ],
        tag: ["Java", "Spring Boot", "Spring Batch", "Mysql", "AWS", "Redis"],
    },
    {
        src: [
            "img/omakorea/grandsale/1.png",
            "img/omakorea/grandsale/2.png",
            "img/omakorea/grandsale/3.png",
            "img/omakorea/grandsale/4.png",
        ],
        isHorizontal: true,
        title: "코리아 그랜드 세일 앱",
        start: "2016-01",
    ...
    {
        src: [
            "img/omakorea/chatgrab/A_main_0.png",
            "img/omakorea/chatgrab/A_main_1_0.png",
            "img/omakorea/chatgrab/A_main_1_1.png"
        ],
        title: "챗그랩 소셜 서비스",
        start: "2015-07",
        end: "2015-12",
    ...
    {
        src: [
            "img/omakorea/wehub/1.png",
            "img/omakorea/wehub/2.png",
            "img/omakorea/wehub/3.png",
            "img/omakorea/wehub/4.png",
            "img/omakorea/wehub/5.png",
        ],
        isHorizontal: true,
        title: "위허브 메신저 앱 서비스",
        start: "2014-09",
...
function getFutureDate() {
    ...
    var futureDate = new Date(currentDate.getFullYear() + 2, currentDate.getMonth(), currentDate.getDate());
...
function createGraph() {
    ...
    const tickWidth = 100 / lineLengthByYear; // 각 눈금의 너비 (가로로 등간격 배치)
